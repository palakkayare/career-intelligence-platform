...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.URLField(
                        blank=True,
                        help_text="Link to online resume (Drive, GitHub, etc.). Phase 2 mein resume upload aayega.",
                    ),
                ),
                (
                    "status",
        ...
        migrations.AddIndex(
            ...
            index=models.Index(
                fields=["job", "status", "is_deleted"],
                name="application_job_id_16dd11_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="application",
            index=models.Index(
                fields=["seeker", "-submitted_at"],
                name="application_seeker__3d6e31_idx",
            ),
        ),

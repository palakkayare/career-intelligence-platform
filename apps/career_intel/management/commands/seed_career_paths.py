...
from apps.career_intel.models import CareerPathNode, CareerPathEdge, TargetRole
...
NODES = [
    ...
    {'slug': 'junior-backend-dev', 'name': 'Junior Backend Developer', 'level': 2,
     'category': 'engineering', 'typical_experience_years': 1,
     'avg_salary_inr': Decimal('800000.00')},
    {'slug': 'backend-dev', 'name': 'Backend Developer', 'level': 3,
     'category': 'engineering', 'typical_experience_years': 3,
     'avg_salary_inr': Decimal('1500000.00')},
    {'slug': 'senior-backend-dev', 'name': 'Senior Backend Developer', 'level': 4,
     'category': 'engineering', 'typical_experience_years': 6,
     'avg_salary_inr': Decimal('2800000.00')},
    {'slug': 'tech-lead', 'name': 'Tech Lead', 'level': 5,
     'category': 'engineering', 'typical_experience_years': 8,
     'avg_salary_inr': Decimal('4000000.00')},
    {'slug': 'engineering-manager', 'name': 'Engineering Manager', 'level': 5,
     'category': 'engineering', 'typical_experience_years': 8,
     'avg_salary_inr': Decimal('4500000.00')},
    {'slug': 'principal-engineer', 'name': 'Principal Engineer', 'level': 5,
     'category': 'engineering', 'typical_experience_years': 10,
     'avg_salary_inr': Decimal('5500000.00')},
    {'slug': 'engineering-director', 'name': 'Engineering Director', 'level': 6,
     'category': 'engineering', 'typical_experience_years': 12,
     'avg_salary_inr': Decimal('7000000.00')},
    {'slug': 'cto', 'name': 'CTO', 'level': 6,
     'category': 'engineering', 'typical_experience_years': 15,
     'avg_salary_inr': Decimal('10000000.00')},

    # --- Frontend track ---
    {'slug': 'junior-frontend-dev', 'name': 'Junior Frontend Developer', 'level': 2,
     'category': 'engineering', 'typical_experience_years': 1,
     'avg_salary_inr': Decimal('750000.00')},
    {'slug': 'frontend-dev', 'name': 'Frontend Developer', 'level': 3,
     'category': 'engineering', 'typical_experience_years': 3,
     'avg_salary_inr': Decimal('1400000.00')},
    {'slug': 'senior-frontend-dev', 'name': 'Senior Frontend Developer', 'level': 4,
     'category': 'engineering', 'typical_experience_years': 6,
     'avg_salary_inr': Decimal('2600000.00')},

    # --- Full stack ---
    {'slug': 'full-stack-dev', 'name': 'Full Stack Developer', 'level': 3,
     'category': 'engineering', 'typical_experience_years': 4,
     'avg_salary_inr': Decimal('1800000.00')},

    # --- Data track ---
    {'slug': 'data-analyst', 'name': 'Data Analyst', 'level': 2,
     'category': 'data', 'typical_experience_years': 1,
     'avg_salary_inr': Decimal('700000.00')},
    {'slug': 'data-scientist', 'name': 'Data Scientist', 'level': 3,
     'category': 'data', 'typical_experience_years': 3,
     'avg_salary_inr': Decimal('1600000.00')},
    {'slug': 'senior-data-scientist', 'name': 'Senior Data Scientist', 'level': 4,
     'category': 'data', 'typical_experience_years': 6,
     'avg_salary_inr': Decimal('2900000.00')},

    # --- DevOps ---
    {'slug': 'devops-engineer', 'name': 'DevOps Engineer', 'level': 3,
     'category': 'engineering', 'typical_experience_years': 3,
     'avg_salary_inr': Decimal('1600000.00')},
    {'slug': 'senior-devops', 'name': 'Senior DevOps Engineer', 'level': 4,
     'category': 'engineering', 'typical_experience_years': 6,
     'avg_salary_inr': Decimal('2800000.00')},

    # --- Product ---
    {'slug': 'associate-pm', 'name': 'Associate Product Manager', 'level': 2,
     'category': 'product', 'typical_experience_years': 1,
     'avg_salary_inr': Decimal('900000.00')},
    {'slug': 'product-manager', 'name': 'Product Manager', 'level': 3,
     'category': 'product', 'typical_experience_years': 4,
     'avg_salary_inr': Decimal('2200000.00')},
    {'slug': 'senior-pm', 'name': 'Senior Product Manager', 'level': 4,
     'category': 'product', 'typical_experience_years': 7,
     'avg_salary_inr': Decimal('3500000.00')},

    # --- Design ---
    {'slug': 'junior-designer', 'name': 'Junior UI/UX Designer', 'level': 2,
     'category': 'design', 'typical_experience_years': 1,
     'avg_salary_inr': Decimal('600000.00')},
    {'slug': 'designer', 'name': 'UI/UX Designer', 'level': 3,
     'category': 'design', 'typical_experience_years': 3,
     'avg_salary_inr': Decimal('1200000.00')},
    {'slug': 'senior-designer', 'name': 'Senior UI/UX Designer', 'level': 4,
     'category': 'design', 'typical_experience_years': 6,
     'avg_salary_inr': Decimal('2200000.00')},
]
    ...
    def handle(self, *args, **options):
        ...
        for from_slug, to_slug, weight, months, ttype, rationale, skill_names in EDGES:
            ...
            if not from_node or not to_node:
                self.stderr.write(
                    f"WARNING: skipping edge, missing node {from_slug} or {to_slug}"
                )
                continue

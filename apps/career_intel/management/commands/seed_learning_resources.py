...
RESOURCES = [
    # --- Python ---
    {
        ...
        'description': (
            'Beginner-friendly introduction to Python by the University of '
            'Michigan.'
        ),
        'kind': 'course',
        'difficulty': 'beginner',
    ...
    # --- Docker ---
    {
        ...
        'description': (
            'Comprehensive Docker course with an introduction to Kubernetes, '
            'by Bret Fisher.'
        ),
        'kind': 'course',
        'difficulty': 'beginner',
    ...
    # --- Kubernetes ---
    {
        ...
        'url': (
            'https://www.oreilly.com/library/view/kubernetes-up-and/'
            '9781098110192/'
        ),
    ...
    # --- React ---
    {
        ...
        'description': (
            'Comprehensive Udemy course covering React and Redux, by '
    ...
    # --- Git ---
    {
        ...
        'description': (
            'Free official Git book, the most authoritative resource '
            'available.'
        ),
        'kind': 'book',
        'difficulty': 'beginner',
    ...
    # --- TypeScript ---
    {
        ...
        'description': (
            'Official TypeScript documentation, beginner through advanced.'
        ),
        'kind': 'documentation',
        'difficulty': 'beginner',
        'duration_hours': 12,

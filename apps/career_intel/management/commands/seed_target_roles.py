...
ROLE_DATA = [
    {
        ...
        'description': (
            'Build scalable backend services for high-traffic applications.'
        ),
    ...
    },
    {
        ...
        'description': (
            'Build and maintain CI/CD, infrastructure, and deployments.'
        ),
        'category': TargetRole.Category.ENGINEERING,
        'min_experience_years': 3,
        'typical_experience_years': 5,
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(
            f"Seeded {created_roles} new role(s) and "
            f"{created_links} new skill link(s)."
        ))
        if missing_skills:

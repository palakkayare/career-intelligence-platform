...
BADGES = [
    ...
    (
        "profile-started",
        "Getting Started",
        "Filled in the basics of your profile.",
        B.Category.PROFILE,
        25,
        10,
        10,
    ...
    (
        "skills-5",
        "Five Skills",
        "Added five skills to your profile.",
        B.Category.SKILLS,
        5,
        15,
        10,
    ...
    (
        "skills-10",
        "Well Rounded",
        "Added ten skills to your profile.",
        B.Category.SKILLS,
        10,
        30,
        20,
    ...
    (
        "first-application",
        "First Step",
        "Sent your first application.",
        B.Category.APPLICATIONS,
        1,
        20,
        10,
    ),
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(self.style.SUCCESS(f"Seeded {len(BADGES)} badges."))

    ...
    operations = [
            ...
            fields=[
                ...
                (
                    ...
                    models.PositiveSmallIntegerField(
                        default=10, help_text="Points awarded on earning this badge."
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="earned_badg_user_id_cc6a4d_idx",
                    )
                ],
                "constraints": [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("match_score_day", "Match scores for 24 hours"),
                            ("skill_gap_day", "Skill gap report for 24 hours"),
                        ],
                        max_length=30,
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["user", "perk", "-expires_at"],
                        name="perk_redemp_user_id_149f4b_idx",
                    )
                ],
            },
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ("badge", "Badge earned"),
                            ("goal", "Weekly goal met"),
                            ("streak", "Streak milestone"),
                            ("redemption", "Spent on a perk"),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "week_start",
                    models.DateField(help_text="Monday of the week this covers."),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="weekly_goal_user_id_6d311b_idx",
                    )
                ],
                "constraints": [
                    models.UniqueConstraint(

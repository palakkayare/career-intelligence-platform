...
GENERAL_QUESTIONS = [
    (Q.Category.BEHAVIOURAL, Q.Difficulty.ENTRY, 95,
    ...
    (Q.Category.BEHAVIOURAL, Q.Difficulty.ENTRY, 90,
    ...
    (Q.Category.BEHAVIOURAL, Q.Difficulty.MID, 85,
    ...
    (Q.Category.BEHAVIOURAL, Q.Difficulty.MID, 80,
    ...
    (Q.Category.BEHAVIOURAL, Q.Difficulty.ENTRY, 60,
    ...
    (Q.Category.CLOSING, Q.Difficulty.ENTRY, 85,
    ...
    (Q.Category.CLOSING, Q.Difficulty.MID, 60,
...
ROLE_QUESTIONS = {
    'Senior Backend Developer': [
        (Q.Category.TECHNICAL, Q.Difficulty.MID, 90,
        ...
        (Q.Category.TECHNICAL, Q.Difficulty.MID, 85,
         ...
         'they hear most.'),
        (Q.Category.TECHNICAL, Q.Difficulty.SENIOR, 75,
        ...
        (Q.Category.TECHNICAL, Q.Difficulty.MID, 70,
        ...
        (Q.Category.SITUATIONAL, Q.Difficulty.SENIOR, 65,
    ...
    'Senior Frontend Developer': [
        ...
        (Q.Category.TECHNICAL, Q.Difficulty.MID, 80,
        ...
        (Q.Category.TECHNICAL, Q.Difficulty.ENTRY, 75,
    ...
    'Data Scientist': [
        ...
        (Q.Category.SITUATIONAL, Q.Difficulty.MID, 75,
    ...
    'Full Stack Developer': [
        ...
        (Q.Category.SITUATIONAL, Q.Difficulty.MID, 70,
         'You own a feature end to end and the deadline is tight. Where do '
         'you cut?',
    ...
    'Product Manager': [
        (Q.Category.SITUATIONAL, Q.Difficulty.MID, 85,
    ...
    'UI/UX Designer': [
        (Q.Category.SITUATIONAL, Q.Difficulty.MID, 80,
...
STAR_TEMPLATES = [
    ...
    },
    {
        ...
        'situation_prompt': 'What needed to happen, and who could actually '
                            'make the decision?',
        ...
        'result_prompt': 'Did they move? If not, say so and say what you '
                         'learned.',
        'worked_example': '',
    },
    {
        ...
        'situation_prompt': 'What went wrong? Say it plainly, without '
                            'softening.',
        'task_prompt': 'What was your part in it specifically?',
        'action_prompt': 'What did you do when you realised - how quickly did '
                         'you tell someone?',
    ...
    },
    {
        ...
        'result_prompt': 'What shipped, and what was the cost of the choices '
                         'you made?',
        'worked_example': '',
    },
]
...
NEGOTIATION_SCRIPTS = [
    {
        ...
        'situation': 'Early in the process, often from HR: "What are your '
                     'salary expectations?"',
        'script': (
        ...
        'tactics': [
            'Deflecting once is normal and expected. Deflecting three times '
            'reads as evasive.',
        ...
        'mistakes': [
            ...
            'Giving a range so wide it tells them nothing except that you '
            'have not researched.',
        ],
    },
    {
        ...
        'situation': 'The offer arrives well below what you expected or what '
                     'the market pays.',
        'script': (
    ...
    },
    {
        ...
        'tactics': [
            'One counter, not three. A second round of haggling costs '
            'goodwill for very little.',
            'Offering an alternative lever gives them a way to say yes when '
            'the base is genuinely fixed.',
            'Put it in writing so it can be forwarded to whoever actually '
            'approves it.',
        ],
        'mistakes': [
    ...
    },
    {
        ...
        'situation': 'Another company has made you an offer and you would '
                     'prefer this one.',
        'script': (
    ...
    },
    {
        ...
        'situation': 'The base is genuinely fixed, usually by a band or a '
                     'level.',
        'script': (
        ...
        'tactics': [
            ...
            'A written six-month review is worth more than a verbal promise '
            'of one.',
...
CHECKLIST = [
    (C.Phase.PREPARATION, 10, 'Re-read the job description',
     'Pull out the three things they repeat. Those are what the interview '
     'will be about.'),
    (C.Phase.PREPARATION, 20, 'Prepare three STAR stories',
    ...
    (C.Phase.PREPARATION, 30, 'Research the interviewers',
     'What they work on, not their life story. It shapes the questions you '
     'ask them.'),
    (C.Phase.PREPARATION, 40, 'Write down three questions to ask',
     'Have more than you need. Two often get answered before you can ask.'),
    (C.Phase.PREPARATION, 50, 'Know your number',
     'Decide your range and your walk-away figure before anyone asks. '
     'Deciding under pressure goes badly.'),
    (C.Phase.PREPARATION, 60, 'Test the setup',
     'For a remote interview: camera, microphone, the actual meeting link. '
     'Do it the day before, not five minutes before.'),

    (C.Phase.DAY_OF, 10, 'Re-read your own resume',
     'You will be asked about something you did four years ago and half '
     'forgot.'),
    (C.Phase.DAY_OF, 20, 'Arrive or join five minutes early',
     'Early enough to settle, not so early that you are waiting and '
     'tensing up.'),
    (C.Phase.DAY_OF, 30, 'Keep water and a notepad within reach',
     'Writing down a question buys you a few seconds to think.'),
    (C.Phase.DAY_OF, 40, 'Ask about next steps before you leave',
     'What happens next and when. It saves a week of wondering.'),

    (C.Phase.FOLLOW_UP, 10, 'Send a thank-you note within 24 hours',
     'Three sentences. Reference something specific from the conversation.'),
    (C.Phase.FOLLOW_UP, 20, 'Write down what you were asked',
     'While it is fresh. The same questions come up at the next company.'),
    (C.Phase.FOLLOW_UP, 30, 'Note what you would answer differently',
     'This is the part that makes the next interview better.'),
    (C.Phase.FOLLOW_UP, 40, 'Follow up if the date they gave has passed',
     'One polite message. Silence usually means their process slipped, not '
     'that you failed.'),
]
    ...
    def _seed_questions(self):
        ...
        for category, difficulty, frequency, question, guidance in GENERAL_QUESTIONS:
            InterviewQuestion.objects.update_or_create(
                question=question, target_role=None,
                defaults={
                    'category': category, 'difficulty': difficulty,
                    'asked_frequency': frequency, 'guidance': guidance,
                },
            )
            total += 1
        ...
        for role_name, questions in ROLE_QUESTIONS.items():
            ...
            for category, difficulty, frequency, question, guidance in questions:
                InterviewQuestion.objects.update_or_create(
                    question=question, target_role=role,
                    defaults={
                        'category': category, 'difficulty': difficulty,
                        'asked_frequency': frequency, 'guidance': guidance,
                    },
    ...
    def _seed_star(self):
        for template in STAR_TEMPLATES:
            StarTemplate.objects.update_or_create(
                ...
                defaults={k: v for k, v in template.items()
                          if k != 'competency'},
            )

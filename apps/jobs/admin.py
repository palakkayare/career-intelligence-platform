...
class JobAdmin(admin.ModelAdmin):
    list_display = (
        ...
        'application_count', 'view_count', 'activated_at', 'is_deleted',
    )
    list_filter = (
        'status', 'employment_type', 'work_arrangement',
        'is_deleted', 'company__is_verified',
    )
    search_fields = ('title', 'description', 'company__name')
    raw_id_fields = ('company', 'posted_by', 'category', 'approved_by')
    readonly_fields = (
        'public_id', 'view_count', 'application_count',
        'submitted_at', 'activated_at', 'closed_at',

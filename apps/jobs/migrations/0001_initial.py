        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "required_skills",
                    models.ManyToManyField(
                        related_name="required_for_jobs", to="skills.skill"
                    ),
                ),
                (
                    "category",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["status", "is_deleted", "-activated_at"],
                        name="jobs_status_8129b2_idx",
                    ),
                    models.Index(
                        fields=["company", "status"], name="jobs_company_0582d9_idx"
                    ),
                    models.Index(
                        fields=["category", "status"], name="jobs_categor_1a990f_idx"
                    ),
                ],
            },
        ),

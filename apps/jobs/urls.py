...
from .views import (
    ...
    CloseJobView,
    DuplicateJobView,
    ExecuteSavedSearchView,
    IncrementJobViewView,
    JobCategoryListView,
    JobDetailView,
    JobSearchView,
    JobUpdateDestroyView,
    MyJobListCreateView,
    PublicJobListView,
    SavedJobListView,
    SavedSearchDestroyView,
...
jobs_patterns = [
    ...
    path(
        ...
        SavedSearchDestroyView.as_view(),
        name="saved-delete",
    ),
    path(
        "saved-searches/<int:pk>/execute/",
        ExecuteSavedSearchView.as_view(),
        name="saved-execute",
    ),
    # History
    ...
    path(
        "<uuid:public_id>/back-to-draft/",
        BackToDraftView.as_view(),
        name="back-to-draft",
    ),
]

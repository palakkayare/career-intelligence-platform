...
class MatchScoreAdmin(admin.ModelAdmin):
    list_display = (
        'seeker_email', 'job_title', 'overall_score',
        'skills_score', 'experience_score', 'computed_at',
    )
    list_filter = (
    ...
    search_fields = (
        'seeker__user__email', 'seeker__full_name',
...
class SavedCandidateAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        'recruiter__user__email', 'seeker__user__email',
        'recruiter__full_name', 'seeker__full_name',
    )

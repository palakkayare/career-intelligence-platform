...
def test_experience_inside_the_range_is_a_perfect_fit():
    result = compute_experience_score(seeker_years=4, job_min_years=3,
                                      job_max_years=6)
...
def test_under_qualification_costs_20_points_a_year():
    result = compute_experience_score(seeker_years=1, job_min_years=3,
                                      job_max_years=6)
...
def test_over_qualification_never_drops_below_50():
    result = compute_experience_score(seeker_years=40, job_min_years=1,
                                      job_max_years=2)
...
def test_city_matching_ignores_case_and_state_suffix():
    result = compute_location_score(
        'bangalore, karnataka', 'Bangalore, KA', 'onsite',
    )
...
def test_an_undisclosed_salary_gets_a_mild_benefit_of_the_doubt():
    result = compute_salary_score(seeker_years=3, job_min_inr=0,
                                  job_max_inr=0)
...
@pytest.mark.parametrize('years,expected_band', [
    (0, (3, 8)),
    (1, (3, 8)),
    (2, (8, 18)),
    (4, (8, 18)),

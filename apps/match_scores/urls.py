...
job_match_patterns = [
    ...
    path('<uuid:public_id>/recommended-candidates/', JobRecommendedCandidatesView.as_view(), name='recommended-candidates'),
]
...
match_patterns = [
    ...
    path('saved-candidates/<int:pk>/', SavedCandidateDetailView.as_view(), name='saved-candidate-detail'),
]
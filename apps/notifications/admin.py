...
class NotificationAdmin(admin.ModelAdmin):
    list_display = (
        'id', 'user', 'kind', 'title_short',
        'is_read', 'is_emailed', 'delivery_priority', 'created_at',
    )
    ...
    readonly_fields = (
        'user', 'kind', 'title', 'message', 'link', 'context',
        'delivery_priority', 'is_read', 'read_at',
        'is_emailed', 'emailed_at', 'email_failure',
        'created_at',
    )
...
class NotificationPreferencesAdmin(admin.ModelAdmin):
    list_display = (
        'user', 'email_application_updates', 'email_new_matches_digest',
        'email_payment_events', 'email_marketing',
    )
    list_filter = (
        'email_application_updates', 'email_new_matches_digest',
        'email_payment_events', 'email_marketing',
    )

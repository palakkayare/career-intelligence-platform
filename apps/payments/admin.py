...
from .models import PaymentTransaction, Plan, Refund, Subscription, WebhookEvent
...
class RefundAdmin(admin.ModelAdmin):
    ...
    search_fields = (
        "razorpay_refund_id",
        "transaction__razorpay_payment_id",
        "issued_by__email",
        "reason",
    )

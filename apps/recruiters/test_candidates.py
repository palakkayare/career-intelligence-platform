...
from apps.recruiters.candidate_services import CandidateProfileService, CandidateSearchService
...
def test_opening_a_profile_after_paying_keeps_it_unmasked(recruiter, credits, plans):

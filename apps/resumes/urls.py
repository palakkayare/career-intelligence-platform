...
resumes_patterns = [
    ...
    path(
        "<uuid:public_id>/skills/<int:skill_id>/",
        RemoveResumeSkillView.as_view(),
        name="remove-skill",
    ),
    path(
        "<uuid:public_id>/skills/<int:skill_id>/confirm/",
        ConfirmResumeSkillView.as_view(),
        name="confirm-skill",
    ),
    path("<uuid:public_id>/advanced-ats/", AdvancedAtsView.as_view(), name="advanced-ats"),
    path(
        "<uuid:public_id>/re-analyze-ats/",
        ReAnalyzeAdvancedAtsView.as_view(),
        name="re-analyze-ats",
    ),
]

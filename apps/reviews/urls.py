...
reviews_patterns = [
    path('companies/<int:company_id>/', CompanyReviewListCreateView.as_view(),
         name='company-reviews'),
    path('companies/<int:company_id>/summary/', CompanyReviewSummaryView.as_view(),
         name='company-review-summary'),
    path('companies/<int:company_id>/interviews/',
         InterviewExperienceListCreateView.as_view(), name='company-interviews'),
    ...
    path('moderation/<int:pk>/<str:decision>/', ModerationDecisionView.as_view(),

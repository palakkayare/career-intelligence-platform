...
from .models import SeekerProfile, SeekerSkill, WorkExperience, Education
...
class WorkExperienceSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'description', 'skills_used', 'skill_ids',
        )
    ...
    def validate(self, attrs):
        ...
        if not attrs.get('is_current') and not attrs.get('end_date'):
            raise serializers.ValidationError({
                'end_date': "Past jobs must have an end date."
            })
...
class SeekerProfileSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id',
            'full_name', 'bio', 'location', 'profile_photo',
            'current_title', 'target_role', 'years_of_experience',
            'availability_status', 'visibility',

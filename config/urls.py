...
from apps.recruiters.urls import candidates_patterns, companies_patterns, recruiters_patterns
...
ats_patterns = [
    path("best-practices/", AtsBestPracticesView.as_view(), name="best-practices"),
]
urlpatterns = [
    ...
    path(
        ...
        include((preferences_patterns, "preferences")),
    ),
    ...
    path(
        ...
        include((admin_dashboard_patterns, "admin-dashboard")),
    ),
